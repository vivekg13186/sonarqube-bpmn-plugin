...
public class RuleTestCase {
    ...
    public static void match(String filename,Callback callback) throws Exception {
        System.out.printf("🚩 %s \n",filename);
    ...
    public void fakeJoinValidator() throws Exception {
        ...
        match("test/rules/fake-join/invalid-callActivity.bpmn",(FakeJoinValidator::validate));
        match("test/rules/fake-join/invalid-task.bpmn",(FakeJoinValidator::validate));
        match("test/rules/fake-join/valid.bpmn",(FakeJoinValidator::validate));
        match("test/rules/fake-join/valid-gateway.bpmn",(FakeJoinValidator::validate));
    ...
    public void noBPMNDIValidator() throws Exception{
        ...
        match("test/rules/no-bpmndi/ignore-edge-without-bpmn-element.bpmn",NoBPMNDIValidator::validate);
