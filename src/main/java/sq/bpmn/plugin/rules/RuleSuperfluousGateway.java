...
@Rule(key = RuleSuperfluousGateway.RULE_KEY, name = "Redundant Gateway", description = "A rule that disallows complex gateways.A rule that checks, whether a gateway has only one source and target. Those gateways are superfluous since they don't do anything.")

public class RuleSuperfluousGateway implements BpmnRule {
