...
@Rule(key = RuleSingleBlankStartEvent.RULE_KEY, name = "Multiple start events", description = "A rule that checks whether not more than one blank start event exists per scope.")
public class RuleSingleBlankStartEvent implements BpmnRule {
