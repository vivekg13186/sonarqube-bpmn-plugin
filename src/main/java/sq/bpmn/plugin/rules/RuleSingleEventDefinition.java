...
@Rule(key = RuleSingleEventDefinition.RULE_KEY, name = "Single Event Definition", description = "Checks that an event contains no more than one event definition.")

public class RuleSingleEventDefinition implements BpmnRule{
