...
@Rule(key = NoComplexGatewayRule.RULE_KEY, name = "No Complex Gateway", description = "A rule that disallows complex gateways.")

public class NoComplexGatewayRule implements BpmnRule {
